...
{
    public class CABS_103015_00Map : EntityTypeConfiguration<CABS_103015_00>
    {
        public CABS_103015_00Map()
        {
            // Primary Key
            this.HasKey(t => t.CABS_103015_00ID);

            // Properties
            // Table & Column Mappings
            this.ToTable("CABS_103015_00");
            this.Property(t => t.CABS_103015_00ID).HasColumnName("CABS_103015_00ID");
            ...
            this.Property(t => t.OCC_PHRASE_QUANTITY).HasColumnName("OCC_PHRASE_QUANTITY");
            this.Property(t => t.OCC_PHRASE_AMOUNT).HasColumnName("OCC_PHRASE_AMOUNT");
        }
    }
}
