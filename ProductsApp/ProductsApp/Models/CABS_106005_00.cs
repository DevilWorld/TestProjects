...
{
    public partial class CABS_106005_00
    {
        public int CABS_106005_00ID { get; set; }
        ...
        public double CIRCUIT_CHARGE_INTERSTATE { get; set; }
        public double CIRCUIT_CHARGE_PAYMENT_PLAN_INTERSTATE { get; set; }
        public double CIRCUIT_CHARGE_INTRASTATE { get; set; }
        public double CIRCUIT_CHARGE_PAYMENT_PLAN_INTRASTATE { get; set; }
    }
}
