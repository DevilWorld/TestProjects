...
{
    public partial class CABS_102090_00
    {
        public int CABS_102090_00ID { get; set; }
        ...
        public double TOTAL_CREDIT_ADJUSTMENTS { get; set; }
        public double TOTAL_DEBIT_ADJUSTMENTS { get; set; }
        public double ADJUSTMENTS_APPLIED_TOTAL { get; set; }
        public double TOTAL_OF_PENALTY_CREDIT_ADJUSTMENTS { get; set; }
        public double TOTAL_OF_ALL_OTHER_ADJUSTMENTS { get; set; }
    }
}
